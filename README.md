...
[![My Skills](https://skillicons.dev/icons?i=photoshop,illustrator,figma,vscode,git,html,css,sass,bootstrap,javascript,typescript,jquery,nodejs,expressjs,react,nextjs,styledcomponents,tailwind,apollo,graphql,cs,dotnet,docker,linux,md,prisma,mysql,postgres&theme=dark)](https://skillicons.dev)
